...
{/* <button className="w-50 h-50" onClick={content_of_services}></button> */}
...
{result_Arry_special_services}
      ...
      <button type="button" class="btn btn-outline-primary" onClick={content_of_services} > Please Click Here To Show Data</button>
